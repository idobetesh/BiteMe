...
app.use(cors({ credentials: true, origin: 'https://6034f22399afcc009ed300e0--pleaseworkplease.netlify.app', methods: ["GET", "POST", "OPTIONS", "PUT", "DELETE"], preflightContinue: true }));
